...
router.get("/", (0, checkAuth_1.checkAuth)(user_interface_1.Role.ADMIN), wallet_controller_1.walletControllers.getAllWallets);
router.get("/my-wallet", (0, checkAuth_1.checkAuth)(...Object.values(user_interface_1.Role)), wallet_controller_1.walletControllers.getMyWallet);
router.patch("/:phone", (0, checkAuth_1.checkAuth)(user_interface_1.Role.ADMIN), (0, validateRequest_1.validateRequest)(wallet_validation_1.updateWalletZodSchema), wallet_controller_1.walletControllers.updateWallet);
