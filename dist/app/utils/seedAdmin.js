...
const seedAdmin = () => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const isAdminExists = yield user_model_1.User.findOne({
            phone: envCon_1.envVars.ADMIN_PHONE,
        });
        if (isAdminExists) {
        ...
        const hashedPassword = yield bcryptjs_1.default.hash(envCon_1.envVars.ADMIN_PASSWORD, Number(envCon_1.envVars.BCRYPT_SALT_ROUND) | 10);
        const authProvider = {
            provider: "credentials",
            providerId: envCon_1.envVars.ADMIN_PHONE,
        };
        const payload = {
            name: "Admin",
            phone: envCon_1.envVars.ADMIN_PHONE,
